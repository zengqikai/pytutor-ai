...
每类误区 2 题（fix_error / predict_output），共 16 题。
由 `misconception_exercises.py` seed 端点调用。
"""

MC_EXERCISES = [
    # === M1: 赋值与比较混淆 ===
    {"code":"M1","type":"fix","title":"if 条件中的 = 和 ==","desc":"修复：if x = 10 应该改为 if x == 10","starter":"x = 10\nif x = 10:\n    print('x is ten')","solution":"x = 10\nif x == 10:\n    print('x is ten')","input":"","output":"x is ten\n","hint":"if 后面用 == 比较，不是 = 赋值"},
