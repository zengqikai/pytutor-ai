...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-56px)] flex">
      {/* 左侧品牌区 */}
      <div className="hidden lg:flex w-[480px] bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 flex-col justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 tracking-tight">开始学习之旅</h1>
          <p className="text-lg text-emerald-200 leading-relaxed">
            注册 PyTutor，获得专属的<br/>AI Python 编程导师。
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="mb-10">
            ...
            <p className="text-slate-500">填写信息开始学习</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5">密码 <span className="text-slate-400 font-normal">（8-72字符，含字母和数字）</span></label>
            ...
            <button type="submit" disabled={isLoading}
              className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-3 rounded-xl font-medium hover:from-emerald-600 hover:to-teal-700 disabled:opacity-50 transition-all shadow-sm shadow-emerald-200">
              {isLoading ? "注册中..." : "创建账号"}
            </button>
          </form>

          <p className="text-center text-sm text-slate-500 mt-8">
            已有账号？<Link href="/login" className="text-emerald-600 font-medium hover:underline">去登录 →</Link>
          </p>
        </div>
      </div>
    </div>
